    ...
    return (
      <div className="flex items-center justify-center min-h-100">
        <div className="text-center">
          <Loader2 className="w-8 h-8 animate-spin text-dark mx-auto mb-4" />
          <p className="text-vanilla-600">Loading product...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="flex items-center justify-center min-h-100">
        <div className="text-center">
          ...
          <button
            ...
            className="px-4 py-2 bg-dark text-cream rounded-lg hover:opacity-90 transition"
          >
            Back to Products
          </button>
        </div>
        ...
        <div className="flex items-center gap-3">
          {hasChanges() && (
            <button
              type="button"
              onClick={resetForm}
              className="flex items-center gap-2 px-4 py-2.5 border border-vanilla-200 text-vanilla-700 rounded-lg hover:bg-vanilla-100 transition font-medium"
            >
              ...
              <div>
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="px-3 py-2.5 bg-vanilla-100 text-dark rounded-lg hover:bg-vanilla-200 transition"
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
                {formData.images.map((image, index) => (
                  ...
                  >
                    ...
                    />
                    <div
                      className="absolute inset-0 items-center justify-center bg-vanilla-100"
                      style={{ display: "none" }}
                    >
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto">
            {hasChanges() && (
              <button
                type="button"
                onClick={resetForm}
                className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-4 py-2.5 border border-vanilla-200 text-vanilla-700 rounded-lg hover:bg-vanilla-100 transition font-medium"
              >
                <RefreshCw className="w-4 h-4" />
                Reset
              </button>
