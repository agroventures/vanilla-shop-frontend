...
const Checkout = () => {
    ...
    return (
        <div className="pt-24 min-h-screen bg-vanilla-50 font-sans text-vanilla-800">
            ...
            {/* Steps Indicator - Hide if Payment Iframe is Active */}
            {!iframeUrl && (
                                    ...
                                    <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 sm:gap-4 mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-vanilla-200">
                                        {currentStep > 1 ? (
                                            <button
                                                ...
                                                className="order-2 sm:order-1 flex items-center justify-center gap-2 px-6 py-3 text-vanilla-800 hover:text-vanilla-900 font-bold transition-colors disabled:opacity-50"
                                            >
                                        ...
                                        {currentStep < 3 ? (
                                            ...
                                            >
                                                {isProcessing ? (
                                                    <>
                                                        <Loader2 className="w-5 h-5 animate-spin" /> {iframeUrl ? 'Loading...' : 'Processing...'}
                                                    </>
                                                ) : (
                                                    <>
