      ...
      <div className="max-w-7xl mx-auto px-4 text-center">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className='group relative overflow-hidden rounded-lg cursor-pointer h-64'>
            <video src="https://pub-8476bede5a4146e8b7731cfe515f1c3b.r2.dev/the-vanilla-shop/videos/instagram_video.mp4" autoPlay loop muted playsinline controls className="w-full h-full object-cover"></video>
          </div>
        </div>
