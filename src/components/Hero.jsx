  ...
  return (
    ...
    {/* // <section id="home" className="relative h-screen flex items-center justify-center object-cover bg-center" style={{ backgroundImage: "linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url('/images/vanilla-shop.png')" }}> */}
      <div className="text-center text-white px-4 max-w-4xl mx-auto">
        ...
        <p className="text-lg md:text-2xl font-light mb-10 opacity-90">Experience vanilla in its purest form. A sensory journey of sweetness, warmth, and craftsmanship.</p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a href="#products" className="bg-gold-500 text-white px-8 py-3 rounded-md font-semibold hover:bg-yellow-600 transition shadow-lg">Shop Collection</a>
          <a href="#visit" className="bg-transparent border-2 border-white text-white px-8 py-3 rounded-md font-semibold hover:bg-white hover:text-vanilla-900 transition">Visit Café</a>
        </div>
      </div>
    </section>
  );
